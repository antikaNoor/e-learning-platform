...
const SingleCourseStudentMolecule = ({ lessonID }: SingleCourseStudentMoleculeProps) => {
                        ...
                        <AccordionForEnrolledStudentsLesson
                            ...
                            options={[
                                ...lesson.videos.map((video) => ({
                                    title: video.videoTitle, isVideo: true, ID: video._id,
                                    videoLink: video.videoLink,
                                    videoTitle: video.videoTitle,
                                })),
                                ...lesson.notes.map((note) => ({
                                    title: note.noteTitle, isNote: true, ID: note._id,
