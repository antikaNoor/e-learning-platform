        ...
        const fetchNotifications = async () => {
            try {
                ...
                const hasUnreadNotifications =
                    ...
                    response.data.data.some((notification: any) =>
                        notification.status === 'unread' && notification.type !== 'course_subscribed'
                    );
        ...
        return (
            <div className='flex gap-5'>
                ...
                {showUnreadNotifications && (
                    <div className="absolute top-[90px] right-0 p-4 bg-white shadow-md rounded">
                        ...
                        {notifications.every(notification => notification.status !== 'unread') && (
            ...
            <div className='flex gap-5'>
                ...
                {showUnreadNotifications && (
                    <div className="absolute top-[90px] right-0 p-4 bg-white shadow-md rounded">
                        ...
                        {teacherNotifications.every(notification => notification.status !== 'unread') && (
                            <p>No unread notifications</p>
                        )}
                    </div>
                )}
        ...
        return (
            <div className='flex gap-8'>
                                    ...
                                    <div key={cartData._id} className='flex flex-col gap-2'>
                                        {cartData.courseID.map((course: any) => (
                                            <div key={course._id} className='flex gap-3 items-center'>
                                                <img src={course.thumbnail} className='w-[70px] h-[50px] object-cover rounded'></img>
                ...
                <div className="relative group">
                    ...
                    {showWishlist && (
                        <div className="absolute top-[60px] right-0 p-4 bg-white shadow-md rounded">
                            <div className='max-h-96'>
                                {wishlistData && wishlistData.courseID.length > 0 ? (
