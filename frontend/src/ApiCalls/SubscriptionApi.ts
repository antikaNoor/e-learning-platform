...
import { ADD_TO_CART, REMOVE_FROM_CART, ADD_TO_WISHLIST, SUBSCRIBE, APPROVE_SUBSCRIBE } from '../utils/constants';
...
export const RespondToSubscribeApi = async (data: string, notificationID: string, token: string) => {
    // Fetch data from API
    console.log("token from api", token, data)
    return axiosInstance
        .post(
            `/notification/subscription-approval/${notificationID}`,
            { action: data },
            {
                headers: {
                    'Authorization': `Bearer ${token}`,
...
export const RespondToTeacherReqApi = async (data: string, notificationID: string, token: string) => {
    // Fetch data from API
    console.log("token from api", token, data)
    return axiosInstance
        .post(
            `/notification/teacher-approval/${notificationID}`,
            { action: data },
            {
                headers: {
                    'Authorization': `Bearer ${token}`,
...
export const RespondToCourseReqApi = async (data: string, notificationID: string, token: string) => {
    // Fetch data from API
    console.log("token from api", token, data)
    return axiosInstance
        .post(
            `/notification/course-approval/${notificationID}`,
            { action: data },
            {
                headers: {
                    'Authorization': `Bearer ${token}`,
